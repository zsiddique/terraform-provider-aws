		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// TODO probably check some of the attrs to make sure they're correct
				),
			},
			// TODO import test once that is implemented
		},
	})
}
...
func testAccCheckAWSEcsCapacityProviderDestroy(s *terraform.State) error {
	// TODO implement this once delete isn't a Noop
	return nil
}
...
// TODO tags test separately if those are in fact optional
