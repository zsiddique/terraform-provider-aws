...
func resourceAwsEcsCapacityProviderUpdate(d *schema.ResourceData, meta interface{}) error {
	// TODO there doesn't seem to be an UpdateCapacityProvider or similar method that exists in the SDK yet
	return nil
}
...
func expandAutoScalingGroupProvider(configured interface{}) *ecs.AutoScalingGroupProvider {
	...
	// TODO it feels like there ought to be a better way of doing this.
